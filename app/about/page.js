        ...
        <div className="container mx-auto min-h-screen px-5 py-8">
          ...
          <div className="mt-3 flex flex-col sm:flex-row">
            <div className="text-center sm:w-1/3 sm:py-8 sm:pr-8">
              ...
              <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8 dark:bg-gray-800">
                ...
                <div>
                  ...
                  <div className="flex justify-center">
                    ...
                    <a href="https://github.com/vividnow" className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300" target="_blank">
                      ...
                      <a href="https://veams.tistory.com/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank">
            ...
            <div className="mt-4 border-t border-gray-200 pt-4 text-center sm:mt-0 sm:w-2/3 sm:border-l sm:border-t-0 sm:py-8 sm:pl-8 sm:text-left">
              ...
              &nbsp;&nbsp;저는 늘 각 개인의 성장을 돕는 것에 관심이 많았습니다. 
              ...
              <div className="flex justify-around">
                <Link
                  ...
                  className="inline-flex items-center text-indigo-500" target="_blank"
                >
                  이력서 보기
                  <svg
                    fill="none"
