        ...
        <div className="bg-gray-100 dark:bg-gray-800">
          <div className="container mx-auto flex flex-col items-center px-5 py-6 sm:flex-row">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:ml-6 sm:mt-0">
              © 2024 김재광 All rights reserved.
                @VIVIDNOW
            </p>
            <span className="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
            <div className="flex gap-4">
                    <Link href="https://github.com/belucent0" className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300" target="_blank"  rel="noreferrer noopener">
                      ...
                      <Link href="https://veams.tistory.com/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank"  rel="noreferrer noopener">
