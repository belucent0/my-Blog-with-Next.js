            ...
            <div className="container mx-auto min-h-screen px-3 py-3 md:px-24">
                ...
                <div className="mx-auto h-full px-5">
                    <div className="h-[82vh] sm:h-[85vh] md:h-[88vh]">
                        ...
                        <Link href="/blog" className="my-5 block text-center text-lg font-black text-purple-700 hover:text-purple-500">
                            이전 페이지로 이동
                        </Link>
                    </div>
                </div>
                                    ...
                                    >
                                        <Dialog.Panel className="w-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                            <h3 className="flex justify-between text-lg font-medium leading-6 text-gray-900">
                                                <div className="text-xs md:text-sm">종료 전 저장 필수!</div>
                                                <h1 className="text-center text-xl font-medium md:text-3xl">그림판</h1>
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-500">
                                                    <div className="mx-auto h-full w-full px-5">
                                                        <div className="h-[82vh] sm:h-[85vh] md:h-[88vh]">
                                                            {isLoading ? <Loading /> : Excalidraw && <Excalidraw className="h-full w-full" />}
                                                        </div>
                                                    </div>
                                                </p>
                                            </div>
