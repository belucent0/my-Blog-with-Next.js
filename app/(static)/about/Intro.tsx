                ...
                <div className="container mx-auto min-h-screen px-5 py-8">
                    <div className="mb-5 flex w-full flex-wrap">
                        <div className="mb-6 w-full lg:mb-0 lg:w-1/2">
                            <h1 className="title-font mb-2 text-2xl font-medium text-gray-900 sm:text-3xl">소개</h1>
                            <div className="h-1 w-20 rounded bg-indigo-700"></div>
                        </div>
                        <p className="w-full leading-relaxed text-gray-800 lg:w-1/2">
                            전직 심리상담사로서, 프로젝트시 팀내 상황파악 및 공유를 중시하며 동료 특성에 맞는 소통 스타일을 구사할 수 있습니다. 적극적
                            소통으로 팀내 필요한 작업을 캐치하여 팀내 제약사항을 파악하고 협력하는 역할에 능숙합니다.
                        </p>
                    ...
                    <div className="mt-3 flex flex-col sm:flex-row">
                        ...
                        <div className="mt-4 border-t border-gray-200 pt-4 text-center sm:mt-0 sm:w-2/3 sm:border-l sm:border-t-0 sm:py-8 sm:pl-8 sm:text-left">
                            <p className="mb-4 text-lg leading-relaxed text-gray-600">
                                &nbsp;&nbsp;늘 사람의 성장을 돕는 것에 관심이 많았습니다. 각기 다른 개인이 자신의 라이프스타일 속에서 어떻게 자신의
                                어려움을 해결하며 삶을 성장시켜 나가는지 호기심이 있습니다. 그래서 심리상담 및 교육분야에서 경험을 쌓으며 각기 다른
                                다양한 사람들이 자기 마음을 읽고 발전하는데 도움을 줄 수 있을지 고민해왔습니다.
                            </p>
                            <p className="mb-4 text-lg leading-relaxed text-gray-600">
                                &nbsp;&nbsp;이 관심은 웹을 개발하는 현재에도 변함이 없습니다. 이제 개발자라는 새로운 역할을 기반으로, 웹 서비스를
                                제공하며 사람들이 일상에서 겪는 어려움과 불편을 해결하는 조력자가 되고자 합니다. 고객의 마음을 읽어 회사 서비스의
                                성장에 기여하고자 합니다.
                            </p>
                            <p className="mb-8 text-lg leading-relaxed text-gray-600">
                                &nbsp;&nbsp;Node.js 환경에서 처음 개발을 시작했다보니, JavaScript 생태계를 더욱 이해하고 싶은 욕심이 생깁니다. 그동안
                                서버 사이드 개발을 주로 학습하긴했지만, 전체 개발 프로세스를 이해하는 동시에 타 직무와의 소통에 더 능숙한 개발자가
                                되고자 Next.js를 활용하여 이 블로그를 손수 개발하였습니다.
                            </p>
