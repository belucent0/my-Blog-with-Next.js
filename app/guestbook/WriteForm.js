    ...
    <>
      <div >
        <form action="/api/guestbook/new" method="POST" className="relative flex items-baseline items-center">
          <input className="bg-blue-100 pl-4 pr-40 py-2 rounded-lg w-full dark:bg-gray-800" type="text" name="content" placeholder="내용을 입력해주세요" maxLength={100} minlength={2} required/>
